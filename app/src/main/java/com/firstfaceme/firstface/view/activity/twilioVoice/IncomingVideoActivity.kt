...
class IncomingVideoActivity : AppCompatActivity() {
    ...
    private val roomListener = object : Room.Listener {
        ...
        override fun onDisconnected(room: Room, e: TwilioException?) {
            ...
            reconnectingProgressBar.visibility = View.GONE;
            this@IncomingVideoActivity.room = null
    ...
    private val sharedPreferences by lazy {
        PreferenceManager.getDefaultSharedPreferences(this@IncomingVideoActivity)
    }
    ...
    private val audioSwitch by lazy {
        AudioSwitch(applicationContext, preferredDeviceList = listOf(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        {
            getToken(intent.getStringExtra("QUEUEID"))
        }
        ...
        return View.OnClickListener {
            ...
            localVideoTrack?.let {
                ...
                localVideoActionFab.setImageDrawable(
                    ContextCompat.getDrawable(this@IncomingVideoActivity, icon))
            }
        }
    }
        ...
        return View.OnClickListener {
            ...
            localAudioTrack?.let {
                ...
                muteActionFab.setImageDrawable(ContextCompat.getDrawable(
                    this@IncomingVideoActivity, icon))
            }
        }
    }
    ...
    fun getToken(QueID:String) {
        viewModel!!.getTwilioToken(
            auth_token,
            mUserId, QueID
        )
            .observe(
                ...
                { pojoToken ->
                    ...
                    if (statusCode == 200) {
                        ...
                        connectToRoom("60fd02fdba3a1a1c0f8f888a")
                    } else {
                        showSnackBar(pojoToken!!.message)
    ...
    fun callTOUser(QueID:String,otherUSerID:String) {
        viewModel!!.callTwilio(
            auth_token,
            mUserId,otherUSerID, QueID
        )
            .observe(
                this,
                { pojoUserProfileData ->
