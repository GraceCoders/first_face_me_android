package com.firstfaceme.firstface.controller.CustomViews
...
class MyTextViewItalic: AppCompatTextView {
    ...
    fun setCustomFont(ctx: Context, asset: String?): Boolean {
        ...
        try {
            typeface = Typeface.createFromAsset(ctx.assets, "Montserrat-SemiBoldItalic.ttf")
